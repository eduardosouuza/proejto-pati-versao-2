            ...
            <div className="bg-accent/5 p-4 rounded-lg border border-accent/20">
              <div className="flex items-start space-x-2">
                <input
                  ...
                  onChange={handleChange}
                  className="h-5 w-5 mt-0.5 text-accent focus:ring-accent border-accent/30 rounded"
                />
                <div>
                  <label htmlFor="featured" className="text-sm font-medium text-primary flex items-center">
                    <span className="bg-accent text-white text-xs px-2 py-0.5 rounded mr-2">DESTAQUE</span>
                    Destacar este imóvel na página inicial
                  </label>
                  <p className="text-xs text-neutral-600 mt-1">
                    Imóveis destacados aparecem na seção "Imóveis em Destaque" na página inicial e têm mais 
                    visibilidade. O sistema mostrará todos os imóveis marcados como destaque, ordenados 
                    pela data de criação (mais recentes primeiro).
                  </p>
                </div>
              </div>
            </div>
