            ...
            >
              <div className="relative">
                ...
                <div className="absolute -bottom-8 -right-8 bg-white p-6 shadow-lg rounded-2xl border border-secondary-dark/10 flex flex-col items-center">
                  <span className="text-accent font-display text-3xl font-bold mb-1">2+</span>
                  <span className="text-primary text-sm font-medium">Anos de Experiência</span>
                </div>
              </div>
            </motion.div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            >
              ...
              <p className="text-accent text-4xl md:text-5xl font-display font-bold mb-2">2+</p>
              <p className="text-primary/70 font-medium">Anos de Experiência</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
